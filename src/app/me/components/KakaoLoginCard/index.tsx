    ...
    return (
      <div className="flex gap-4 items-center">
        ...
        <div className="flex w-full justify-between items-center">
          <div>
            <p className="truncate max-w-[160px] sm:max-w-[200px] font-black text-xl -mb-2">
              {email || '이메일 정보 없음'}
            </p>
          ...
          <Button
            ...
            radius="full"
            variant="flat"
            className="bg-gray-100 text-gray-600 font-bold px-4 shrink-0"
  ...
  return (
    <div className="flex items-center justify-between bg-primary/5 border border-primary/10 rounded-xl p-3 px-4">
      ...
      <Button
        size="sm"
        radius="full"
        className="bg-[#FEE500] hover:bg-[#FEE500]/90 text-black/85 font-bold h-8 px-4 text-xs shadow-sm shrink-0"
